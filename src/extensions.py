...
Place this file in the same src/ folder as 06_extensions.py.
"""
...
_target  = _src_dir / '06_extensions.py'

_spec = importlib.util.spec_from_file_location('extensions', _target)
