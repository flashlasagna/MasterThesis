"""
burnin.py — import alias for 010_burnin.py
Python cannot import files whose names start with a digit.
Place this file in the same src/ folder as 010_burnin.py.
"""
...
_target  = _src_dir / '010_burnin.py'

_spec = importlib.util.spec_from_file_location('burnin', _target)
